 ...
 * @author asena5
 */
public class PredictiveProbabilityMapper implements RowMapper<PredictiveProbabilityRecord> {
	
        @Override
	public PredictiveProbabilityRecord mapRow(ResultSet rs, int rowNum) throws SQLException {
		PredictiveProbabilityRecord record = new PredictiveProbabilityRecord();
